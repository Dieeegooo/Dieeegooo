...
- 🔥 Approfondendo **Spring Boot** per costruire API REST robuste e scalabili
- 📱 Esplorando lo sviluppo mobile con **React Native**
- 🐳 Imparando **Docker** e i principi di base del DevOps
- 🧪 Costruendo piccoli progetti per consolidare ogni argomento studiato a lezione
